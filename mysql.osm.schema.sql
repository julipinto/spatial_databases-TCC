...
CREATE DATABASE IF NOT EXISTS bahia
  DEFAULT CHARACTER SET utf8mb4
  DEFAULT COLLATE utf8mb4_unicode_ci;
USE bahia;

--
-- Definition of table `bahia`.`acls`
--

DROP TABLE IF EXISTS `bahia`.`acls`;
CREATE TABLE  `bahia`.`acls` (
...
--
-- Dumping data for table `bahia`.`acls`
--
...
--
-- Definition of table `bahia`.`changeset_tags`
--

DROP TABLE IF EXISTS `bahia`.`changeset_tags`;
CREATE TABLE  `bahia`.`changeset_tags` (
...
--
-- Dumping data for table `bahia`.`changeset_tags`
--
...
--
-- Definition of table `bahia`.`changesets`
--

DROP TABLE IF EXISTS `bahia`.`changesets`;
CREATE TABLE  `bahia`.`changesets` (
...
--
-- Dumping data for table `bahia`.`changesets`
--
...
--
-- Definition of table `bahia`.`current_node_tags`
--

DROP TABLE IF EXISTS `bahia`.`current_node_tags`;
CREATE TABLE  `bahia`.`current_node_tags` (
...
--
-- Dumping data for table `bahia`.`current_node_tags`
--
...
--
-- Definition of table `bahia`.`current_nodes`
--

DROP TABLE IF EXISTS `bahia`.`current_nodes`;
CREATE TABLE  `bahia`.`current_nodes` (
...
--
-- Dumping data for table `bahia`.`current_nodes`
--
...
--
-- Definition of table `bahia`.`current_relation_members`
--

DROP TABLE IF EXISTS `bahia`.`current_relation_members`;
CREATE TABLE  `bahia`.`current_relation_members` (
...
--
-- Dumping data for table `bahia`.`current_relation_members`
--
...
--
-- Definition of table `bahia`.`current_relation_tags`
--

DROP TABLE IF EXISTS `bahia`.`current_relation_tags`;
CREATE TABLE  `bahia`.`current_relation_tags` (
...
--
-- Dumping data for table `bahia`.`current_relation_tags`
--
...
--
-- Definition of table `bahia`.`current_relations`
--

DROP TABLE IF EXISTS `bahia`.`current_relations`;
CREATE TABLE  `bahia`.`current_relations` (
...
--
-- Dumping data for table `bahia`.`current_relations`
--
...
--
-- Definition of table `bahia`.`current_way_nodes`
--

DROP TABLE IF EXISTS `bahia`.`current_way_nodes`;
CREATE TABLE  `bahia`.`current_way_nodes` (
  `id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
...
--
-- Dumping data for table `bahia`.`current_way_nodes`
--
...
--
-- Definition of table `bahia`.`current_way_tags`
--

DROP TABLE IF EXISTS `bahia`.`current_way_tags`;
CREATE TABLE  `bahia`.`current_way_tags` (
...
--
-- Dumping data for table `bahia`.`current_way_tags`
--
...
--
-- Definition of table `bahia`.`current_ways`
--

DROP TABLE IF EXISTS `bahia`.`current_ways`;
CREATE TABLE  `bahia`.`current_ways` (
  `id` bigint(64) NOT NULL auto_increment,
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `visible` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `bahia`.`current_ways`
--
...
--
-- Definition of table `bahia`.`diary_comments`
--

DROP TABLE IF EXISTS `bahia`.`diary_comments`;
CREATE TABLE  `bahia`.`diary_comments` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `bahia`.`diary_comments`
--
...
--
-- Definition of table `bahia`.`diary_entries`
--

DROP TABLE IF EXISTS `bahia`.`diary_entries`;
CREATE TABLE  `bahia`.`diary_entries` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`diary_entries`
--
...
--
-- Definition of table `bahia`.`friends`
--

DROP TABLE IF EXISTS `bahia`.`friends`;
CREATE TABLE  `bahia`.`friends` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`friends`
--
...
--
-- Definition of table `bahia`.`gps_points`
--

DROP TABLE IF EXISTS `bahia`.`gps_points`;
CREATE TABLE  `bahia`.`gps_points` (
...
--
-- Dumping data for table `bahia`.`gps_points`
--
...
--
-- Definition of table `bahia`.`gpx_file_tags`
--

DROP TABLE IF EXISTS `bahia`.`gpx_file_tags`;
CREATE TABLE  `bahia`.`gpx_file_tags` (
...
--
-- Dumping data for table `bahia`.`gpx_file_tags`
--
...
--
-- Definition of table `bahia`.`gpx_files`
--

DROP TABLE IF EXISTS `bahia`.`gpx_files`;
CREATE TABLE  `bahia`.`gpx_files` (
  `id` bigint(64) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`gpx_files`
--
...
--
-- Definition of table `bahia`.`messages`
--

DROP TABLE IF EXISTS `bahia`.`messages`;
CREATE TABLE  `bahia`.`messages` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `bahia`.`messages`
--
...
--
-- Definition of table `bahia`.`node_tags`
--

DROP TABLE IF EXISTS `bahia`.`node_tags`;
CREATE TABLE  `bahia`.`node_tags` (
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
...
--
-- Dumping data for table `bahia`.`node_tags`
--
...
--
-- Definition of table `bahia`.`nodes`
--
...
--
-- Dumping data for table `bahia`.`nodes`
--
...
--
-- Definition of table `bahia`.`relation_members`
--

DROP TABLE IF EXISTS `bahia`.`relation_members`;
CREATE TABLE  `bahia`.`relation_members` (
...
--
-- Dumping data for table `bahia`.`relation_members`
--
...
--
-- Definition of table `bahia`.`relation_tags`
--

DROP TABLE IF EXISTS `bahia`.`relation_tags`;
CREATE TABLE  `bahia`.`relation_tags` (
  `relation_id` bigint(64) NOT NULL default '0',
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`relation_tags`
--
...
--
-- Definition of table `bahia`.`relations`
--

DROP TABLE IF EXISTS `bahia`.`relations`;
CREATE TABLE  `bahia`.`relations` (
  `relation_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`relations`
--
...
--
-- Definition of table `bahia`.`schema_migrations`
--

DROP TABLE IF EXISTS `bahia`.`schema_migrations`;
CREATE TABLE  `bahia`.`schema_migrations` (
  `version` varchar(255) NOT NULL,
  UNIQUE KEY `unique_schema_migrations` (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `bahia`.`schema_migrations`
--

/*!40000 ALTER TABLE `schema_migrations` DISABLE KEYS */;
LOCK TABLES `schema_migrations` WRITE;
INSERT INTO `bahia`.`schema_migrations` VALUES  ('1'),
 ('10'),
 ('11'),
 ('12'),
 ('13'),
...
--
-- Definition of table `bahia`.`sessions`
--

DROP TABLE IF EXISTS `bahia`.`sessions`;
CREATE TABLE  `bahia`.`sessions` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `bahia`.`sessions`
--
...
--
-- Definition of table `bahia`.`user_preferences`
--

DROP TABLE IF EXISTS `bahia`.`user_preferences`;
CREATE TABLE  `bahia`.`user_preferences` (
  `user_id` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `bahia`.`user_preferences`
--
...
--
-- Definition of table `bahia`.`user_tokens`
--

DROP TABLE IF EXISTS `bahia`.`user_tokens`;
CREATE TABLE  `bahia`.`user_tokens` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`user_tokens`
--
...
--
-- Definition of table `bahia`.`users`
--

DROP TABLE IF EXISTS `bahia`.`users`;
CREATE TABLE  `bahia`.`users` (
...
--
-- Dumping data for table `bahia`.`users`
--
...
--
-- Definition of table `bahia`.`way_nodes`
--

DROP TABLE IF EXISTS `bahia`.`way_nodes`;
CREATE TABLE  `bahia`.`way_nodes` (
  `way_id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `sequence_id` bigint(11) NOT NULL,
...
--
-- Dumping data for table `bahia`.`way_nodes`
--
...
--
-- Definition of table `bahia`.`way_tags`
--

DROP TABLE IF EXISTS `bahia`.`way_tags`;
CREATE TABLE  `bahia`.`way_tags` (
...
--
-- Dumping data for table `bahia`.`way_tags`
--
...
--
-- Definition of table `bahia`.`ways`
--

DROP TABLE IF EXISTS `bahia`.`ways`;
CREATE TABLE  `bahia`.`ways` (
  `way_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `bahia`.`ways`
--
...
ALTER TABLE node_tags MODIFY COLUMN v TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE way_tags MODIFY COLUMN v TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
